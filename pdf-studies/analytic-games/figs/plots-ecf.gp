...
base='< ../test-ecfs -pt '.pt.' -R 0.4 -zcut '.zcut.' -beta '.beta.' -alpha '.alpha.' -cumul -eporder 2'
...
set label 2 '{/Symbol a}='.alpha.', {/Symbol b}='.beta.', z_{cut}='.zcut left at graph 0.05, 0.50
